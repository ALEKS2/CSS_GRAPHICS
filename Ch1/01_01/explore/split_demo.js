...
window.onload = function() {
   ...
   hueSlide.oninput = function() {
      ...
      var sineTheta2 = Math.sin(Math.PI/2-hueValue*Math.PI/180+165*Math.PI/180);
      var cosineTheta2 = Math.cos(Math.PI/2-hueValue*Math.PI/180+165*Math.PI/180); 
      var sineTheta3 = Math.sin(Math.PI/2-hueValue*Math.PI/180+195*Math.PI/180);
      var cosineTheta3 = Math.cos(Math.PI/2-hueValue*Math.PI/180+195*Math.PI/180);      
   ...
   function showOutcome() {
      ...
      document.getElementById("outcomebox2").style.backgroundColor = "hsl(" + parseInt(hueValue+165) + "," + satValue + "%, " + lightValue + "%)"; 
      document.getElementById("outcomebox3").style.backgroundColor = "hsl(" + parseInt(hueValue+195) + "," + satValue + "%, " + lightValue + "%)";   
      
      document.getElementById("code1").innerHTML = "hsl("+hueValue+", "+satValue+"%, "+lightValue+"%)";
      document.getElementById("code2").innerHTML = "hsl("+parseInt(hueValue+165)%360+", "+satValue+"%, "+lightValue+"%)";  
      document.getElementById("code3").innerHTML = "hsl("+parseInt(hueValue+195)%360+", "+satValue+"%, "+lightValue+"%)"; 
