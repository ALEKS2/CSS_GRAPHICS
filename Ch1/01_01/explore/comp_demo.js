...
window.onload = function() {
   ...
   hueSlide.oninput = function() {
      ...
      var sineTheta2 = Math.sin(Math.PI/2-hueValue*Math.PI/180+Math.PI);
      var cosineTheta2 = Math.cos(Math.PI/2-hueValue*Math.PI/180+Math.PI);      
   ...
   function showOutcome() {
      ...
      document.getElementById("outcomebox2").style.backgroundColor = "hsl(" + parseInt(hueValue+180) + "," + satValue + "%, " + lightValue + "%)";      
      document.getElementById("code1").innerHTML = "hsl("+hueValue+", "+satValue+"%, "+lightValue+"%)";
      document.getElementById("code2").innerHTML = "hsl("+parseInt(hueValue+180)%360+", "+satValue+"%, "+lightValue+"%)";      
      document.getElementById("code3").innerHTML = document.getElementById("outcomebox").style.backgroundColor;
      document.getElementById("code4").innerHTML = document.getElementById("outcomebox2").style.backgroundColor;      
   }
