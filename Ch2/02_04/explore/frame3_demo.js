...
window.onload = function() {
   ...
   function placeLines() {
      ...
      bottomline.style.bottom = topSlice.value + "px";
      ...
      outcomebox. style.borderImage = "url("+bImg.value+") " + topSlice.value + " " + rightSlice.value + " " + fillValue + " " + hrepeatType + " " + vrepeatType;
