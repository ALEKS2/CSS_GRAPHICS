...
window.onload = function() {
   ...
   var leftSlice = document.getElementById("leftSlice");
   ...
   function placeLines() {
      ...
      leftline.style.left = leftSlice.value + "px"; 
      ...
      outcomebox. style.borderImage = "url("+bImg.value+") " + topSlice.value + " " + rightSlice.value + " " + bottomSlice.value + " " + leftSlice.value + " " + fillValue + " " + hrepeatType + " " + vrepeatType;
      ...
      document.getElementById("leftVal").textContent = leftSlice.value;  
