...
window.onload = function() {
   ...
   function update() {
      ...
      document.getElementById("brbox").style.width = 2*tlhrad.value + "px";
      document.getElementById("brbox").style.height = 2*tlvrad.value + "px";
      document.getElementById("brbox").style.borderRadius = tlhrad.value + "px/"+tlvrad.value+"px";
      ...
      outcomebox.style.borderRadius = tlhrad.value + "px " + trhrad.value + "px / " +  tlvrad.value + "px " + trvrad.value + "px ";
